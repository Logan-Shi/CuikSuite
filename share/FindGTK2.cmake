...
MACRO(_GTK2_FIND_INCLUDE_DIR _var _hdr)
    ...
    ENDIF(${_var})
ENDMACRO(_GTK2_FIND_INCLUDE_DIR _var _hdr)
...
MACRO(_GTK2_FIND_LIBRARY _var _lib _expand_vc _append_version)
    ...
    IF(${_append_version})
        ...
        ENDFOREACH(_ver ${_versions})
    ELSE(${_append_version})
        SET(_lib_list ${_library})
        SET(_libd_list ${_library_d})
    ENDIF(${_append_version})
    ...
    IF(${_var})
        ...
        MARK_AS_ADVANCED(${_var})
    ENDIF(${_var})
ENDMACRO(_GTK2_FIND_LIBRARY _var _lib _expand_vc _append_version)
#=============================================================
...
ENDIF(NOT GTK2_FIND_COMPONENTS)
...
FOREACH(_component ${GTK2_FIND_COMPONENTS})
    ...
    ELSE(_component STREQUAL "gtk")
      IF(_component STREQUAL "gtkmm")
      ...
      ELSE(_component STREQUAL "gtkmm")
        IF(_component STREQUAL "glade")

          _GTK2_FIND_INCLUDE_DIR(GTK2_GLADE_INCLUDE_DIR glade/glade.h)
          _GTK2_FIND_LIBRARY    (GTK2_GLADE_LIBRARY glade 0 1)
    
        ELSE(_component STREQUAL "glade")
          IF(_component STREQUAL "glademm")
          ...
          ELSE(_component STREQUAL "glademm")
            MESSAGE(FATAL_ERROR "Unknown GTK2 component ${_component}")
          ENDIF(_component STREQUAL "glademm")
        ENDIF(_component STREQUAL "glade")
      ENDIF(_component STREQUAL "gtkmm")
    ENDIF(_component STREQUAL "gtk")
ENDFOREACH(_component ${GTK2_FIND_COMPONENTS})
...
FOREACH(_component ${GTK2_FIND_COMPONENTS})
    ...
    ELSE(_component STREQUAL "gtk")
      ...
      ELSE(_component STREQUAL "gtkmm") 
        IF(_component STREQUAL "glade")
          FIND_PACKAGE_HANDLE_STANDARD_ARGS(GTK2_${_COMPONENT_UPPER} "Some or all of the glade libraries were not found."
              GTK2_GLADE_LIBRARY
    ...
    ENDIF(NOT GTK2_${_COMPONENT_UPPER}_FOUND)
