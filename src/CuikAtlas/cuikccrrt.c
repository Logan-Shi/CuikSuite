...
/** \file cuikccrrt.c
    ...
    \brief Main body of the \ref cuikccrrt.c "cuikccrrt" application.
    ...
    digraph applications {
      ...
      cuikccrrt    [label="cuikccrrt"  color="#99ff99" shape=ellipse];
...
/** 
   ...
   Main body of the \ref cuikccrrt.c "cuikccrrt" application.
   ...
   Use:
       - \b cuikccrrt \e problem_name.world
       .
   where
   ...
   \param argc Number of elements in the command line that starts the application (i.e., the 
               \b cuikccrrt command itself and its arguments). 
...
int main(int argc, char **arg)
{
  ...
  if (argc>1)
      ...
      if (argc>2)
	{
	  ...
	  if (nRepetitions==0)
	    Error("Second parameter for cuikccrrt is wrong");
	}
      else
	nRepetitions=1;
	...
	Error("cuikccrrt do not work for problems with dynamics");
 ...
 else
   {
     ...
     fprintf(stderr,"  Use:\n");   
     fprintf(stderr,"      cuikccrrt <problem filename>.%s [num Repetitions]\n",CS_WD_EXT);
